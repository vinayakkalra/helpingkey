...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=ENTER_YOUR_TAG_MANAGER_ID"
    ...
    <div class="d-none d-lg-block position-relative">
        <nav class="d-flex justify-content-center navbar bg-danger font-barlow-r">
            <h6 class="color-white m-0">DUE TO HIGH DEMAND WE ARE LIMITING THE PURCHASE OF ONLY 10 PIECES PER ORDER</h6>                
        </nav>
        <nav class="navbar navbar-expand-lg color-black font-barlow-r">
            <div class="container-fluid">
                <div class="container" style="padding:10px;">
                    <div class="col-2 border-right text-center">
                        <a class="navbar-brand color-black" href="/">Helping <span class="font-saman">Key</span>&#8482;</a>
                    </div>  
                    <div class="col-8 border-right">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="ml-auto mr-auto navbar-nav">
                                <li class="nav-item active">
                                    <a class="nav-link color-black" href="/">Home <span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link color-black" href="for-companies">For Companies</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link color-black" href="affiliate">Earn with us</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link color-black" href="user-login">Logout</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link color-black" href="contact">Contact</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-2 text-center">
                        <h7><i class="fa fa-phone"></i> +91 9876543210</h7>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <div class="container-fluid bg-light" style="text-align:center;">
           <h1 class="font-barlow-eb p-3">Orders</h1>
        </div>
        ...
        <!-- Modal -->
        <div class="modal fade bd-example-modal-lg" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="margin:25px;">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">My Orders / Tracking</h5>
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <div class="row">
                                <div class="col-4"> 
                                    <h6>Item Details</h6>
                                    <img class="img-fluid" src="https://i.imgur.com/iItpzRh.jpg" style="width:100%;height:130px;"> 
                                </div>
                                <div class="col-8"> 
                                    <h6>Order Details</h6>
                                    <div class="row">
                        ...
                        <div class="modal-body">
                            <article class="card">
                                <div class="card-body row">
                                    ...
                                    <div class="col"> <strong>Shipping BY:</strong> <br> BLUEDART </div>
        ...
        <footer class="page-footer font-small mdb-color pt-4">
            ...
            <div class="container text-center text-md-left">
                <!-- Footer links -->
                <div class="row text-center text-md-left mt-5 pb-5">
                    <!-- Grid column -->
                    <div class="col-md-4 col-lg-4 col-xl-4 mx-auto mt-3 font-barlow-m">
                        <h6 class="text-uppercase mb-4 font-weight-bold">Signup for Email Alert</h6>
                        <div class="bg-light p-4">
                            <p>Subscribe for latest articles and resources</p>
                            <div class="form-group has-feedback">
                                <input style="position:relative;" class="form-control " Jessica Brown="email"
                                    type="text" placeholder="Enter Email">
                                <a href="#"><span style="position:absolute;right:54px;top:126px;color:#dc3545;"
                    ...
                    <!-- Grid column -->
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3 font-barlow-m">
                        <h6 class="text-uppercase mb-4 font-weight-bold">Explore</h6>
                        <p>
                            <a class="color-black" href="#!">Contact</a>
                        </p>
                        <p>
                            <a class="color-black" href="#!">Help & FAQs</a>
                        </p>
                        <p>
                            <a class="color-black" href="#!">Terms of Use</a>
                        </p>
                        <p>
                            <a class="color-black" href="#!">Privacy Policy</a>
                        </p>
                    </div>
                    <!-- Grid column -->
                    <hr class="w-100 clearfix d-md-none">
                    <!-- Grid column -->
                    <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3 font-barlow-m">
                        <h6 class="text-uppercase mb-4 font-weight-bold"></h6>
                        <p>
                            <a class="color-black" href="#!">Helping <span class="font-saman">KEY</span>&#8482;</a>
                        </p>
                        <p>
                            <a class="color-black" href="#!">Partner With Us</a>
                        </p>
                        <p>
                            <a class="color-black" href="#!">For Companies</a>
                        </p>
                        <p>
                            <a class="color-black" href="#!">Order Tracking</a>
                        </p>
                    </div>
                    <!-- Grid column -->
                    <hr class="w-100 clearfix d-md-none">
                    ...
                    <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3 font-barlow-m">
                        ...
                        <div class="d-flex">
                            <i class="fa fa-phone mr-3 color-danger p-1"></i>
                            <p>+91 9876543210</p>
                        </div>
                        <div class="d-flex">
                            <i class="fa fa-envelope-open mr-3 color-danger p-1"></i>
                            <p>info@gmail.com</p>
                        </div>
                        <div class="d-flex">
                            <i class="fa fa-map-marker mr-3 color-danger p-1"></i>
                            <p>22 Broklyn Street 30 Road New York, USA</p>
                        </div>
                    </div>
                    <!-- Grid column -->
                </div>
                ...
                <div class="container color-white text-center">
                    ...
                    <div class="row d-flex p-3">
                        ...
                        <div class="col-md-7 col-lg-8">
                            <!--Copyright-->
                            <p class="m-0 text-center text-md-left">© 2019 Copyright:
                                <a class="color-white" href="http://quadbtech.com/"> Quadbtech &#8482;</a>
                            </p>
                        </div>
                        <!-- Grid column -->
                        <!-- Grid column -->
    ...
    <script>
            ...
            success:function(data){
                ...
                $(".order").html(result);
                    ...
                    for(i=0; i<result.length; i++){
                        $(".order").html('<a class="_2WFi0x" href="#"><div class="row"><div class="col-2 d-flex justify-content-center pr-0" style="height:75px;width:75px;"><img src="https://rukminim1.flixcart.com/image/75/75/k5cs87k0/cases-covers/back-cover/v/u/6/karwan-glass-viv0-v17-black-original-imafz244zqgs4vkr.jpeg"></div><div class="col-4 pl-0 pt-2"><p class="color-black mb-0 font-barlow-eb">' + result[i].productName +'X'+ result[i].quantity + '</p><p class="color-black mb-0 font-barlow-r">Gift Your Loved Ones the <span class="font-saman">Key</span> to Safety</p></div><div class="col-4 pl-0 pt-2"><p class="color-black mb-0 font-barlow-r">Price</p><p class="color-black mb-0 font-barlow-r">&#8377;' + result[i].amount + '</p></div><div class="col-2 pt-3 text-center add">'+ (result[i].status=='paid' ? '<button class="btn btn-outline-danger font-barlow-r" data-toggle="modal" data-target="#exampleModalCenter">Track Order</button>' : '<button class="btn btn-outline-danger font-barlow-r">Processing</button>') + '</div></div></a>' + $(".order").html())   
                    }
                }else{
        ...
        // var countDownDate12 = new Date("").getTime();
        // var countDownDate13 = new Date("").getTime();
        // var countDownDate14 = new Date("").getTime();
        // var countDownDate15 = new Date("").getTime();
        // var countDownDate16 = new Date("").getTime();
